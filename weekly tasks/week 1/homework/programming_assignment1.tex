...
Player 2:\\
The player chose rocks.\\
Player 2 won.}

A skeleton of the code is already given for you in a file here, and in CodeSkulptor here. You only need to fill in the commented parts.
...
\begin{itemize}
    \item[2 points]	The function \texttt{who\_won} works correctly according to the rules of the game (i.e., the function outputs 1 when it receives values 0 and 2, it outputs 0 when it receives values 1 and 1, it outputs 2 if it receives values 0 and 1 etc.) You can check this by checking all possibilities in the code and by inspecting the code.
...
\item[2 points] The computer correctly prints what each player chose, using the function \texttt{what\_was\_played}.
